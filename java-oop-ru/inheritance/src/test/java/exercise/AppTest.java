...
class AppTest {
        ...
        @Test
    void testTag() {
            Tag imgTag = new Tag("img",new HashMap<>()) {
        @Override
        public boolean isSelfClosing() {
            return true;
        }
    };
        imgTag.setAttributes("src", "image.jpg");
        imgTag.setAttributes("alt", "My Image");

        String actual1 = imgTag.render();
        String expected1 = "<img src=\"image.jpg\" alt=\"My Image\">";
