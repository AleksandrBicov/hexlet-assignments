...
class ValidationTest {
    ...
    void  testAdvancedValidate(){
        ...
        Map<String, List<String>> expected = new HashMap<>();
            List<String> countryErrors = new ArrayList<>();
                countryErrors.add("length less than 3");
                expected.put("country", countryErrors);
            List<String> streetErrors = new ArrayList<>();
                streetErrors.add("can not be null");
                expected.put("street", streetErrors);
